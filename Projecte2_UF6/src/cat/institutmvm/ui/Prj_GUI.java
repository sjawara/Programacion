...
public class Prj_GUI extends JFrame{
    ...
    setLocation(screenWidth/4,screenHeight / 4);//Ponemos localización al panel
     ...
     getDni.setBounds(10, 42, 360, 20);
     comprovació.setBounds(370, 42, 120, 19);
     panel.add(txtDni);
     panel.add(getDni);
     ...
     nomCognoms.setBounds(10, 53, 100, 30);
     getNomCognoms.setBounds(10, 80,480, 20);
     ...
     TSI.setBounds(10,90,100,30);
     getTSI.setBounds(10, 115, 480, 20);
     ...
     data_naixement.setBounds(10, 125, 100, 30);
     getData_naixement.setBounds(10, 150, 480, 20);
    ...
    edat.setBounds(10, 165, 100, 30);
    getEdat.setBounds(10, 190, 480, 20);
    ...
    gènere.setBounds(10, 205, 100, 30);
    getGènere.setBounds(10, 230, 480, 20);
    panel.add(gènere);
    panel.add(getGènere);
